...
/**
 * Test class for Frida Child process management functionality. Tests child process enumeration,
...
public class ChildTest {
  ...
  private Session createTestSession(DeviceManager deviceManager) {
    ...
    try {
      ...
      assumeTrue(
          false, "Skipping test due to attachment issue (likely SIP on macOS): " + e.getMessage());
