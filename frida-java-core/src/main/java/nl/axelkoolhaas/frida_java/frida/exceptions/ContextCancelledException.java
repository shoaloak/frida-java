 ...
 */
public class ContextCancelledException extends RuntimeException {
    public ContextCancelledException() {
        super("Context was cancelled");
    }

    public ContextCancelledException(String message) {
        super(message);
    }

    public ContextCancelledException(String message, Throwable cause) {
        super(message, cause);
    }
}
