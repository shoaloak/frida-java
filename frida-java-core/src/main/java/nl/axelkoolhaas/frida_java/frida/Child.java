...
public class Child {
    ...
    static {
        ...
        FRIDA_CHILD_GET_PID = FridaLibraryLoader.findFunction("frida_child_get_pid",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_PARENT_PID = FridaLibraryLoader.findFunction("frida_child_get_parent_pid",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_ORIGIN = FridaLibraryLoader.findFunction("frida_child_get_origin",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_IDENTIFIER = FridaLibraryLoader.findFunction("frida_child_get_identifier",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_PATH = FridaLibraryLoader.findFunction("frida_child_get_path",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_ARGV = FridaLibraryLoader.findFunction("frida_child_get_argv",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CHILD_GET_ENVP = FridaLibraryLoader.findFunction("frida_child_get_envp",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    }
    ...
    public String toString() {
        return String.format("Child{pid=%d, parentPid=%d, origin=%s, identifier='%s', path='%s'}",
