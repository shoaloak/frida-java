...
public class CompilerOptions implements AutoCloseable {
    ...
    static {
        ...
        FRIDA_COMPILER_OPTIONS_NEW = FridaLibraryLoader.findFunction("frida_compiler_options_new",
                FunctionDescriptor.of(ValueLayout.ADDRESS));
        FRIDA_COMPILER_OPTIONS_SET_PROJECT_ROOT = FridaLibraryLoader.findFunction("frida_compiler_options_set_project_root",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_COMPILER_OPTIONS_SET_SOURCE_MAPS = FridaLibraryLoader.findFunction("frida_compiler_options_set_source_maps",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_COMPILER_OPTIONS_SET_COMPRESSION = FridaLibraryLoader.findFunction("frida_compiler_options_set_compression",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_COMPILER_OPTIONS_SET_OUTPUT_FORMAT = FridaLibraryLoader.findFunction("frida_compiler_options_set_output_format",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_COMPILER_OPTIONS_SET_BUNDLE_FORMAT = FridaLibraryLoader.findFunction("frida_compiler_options_set_bundle_format",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_COMPILER_OPTIONS_SET_TYPE_CHECK = FridaLibraryLoader.findFunction("frida_compiler_options_set_type_check",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
    }
     ...
     * Use this if your entrypoint script is in another directory besides the current one.
     *
     ...
     * Used internally when passing options to compiler methods.
     */
