...
public class ScriptOptions implements AutoCloseable {
    ...
    static {
        ...
        FRIDA_SCRIPT_OPTIONS_NEW = FridaLibraryLoader.findFunction("frida_script_options_new",
                FunctionDescriptor.of(ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_SET_NAME = FridaLibraryLoader.findFunction("frida_script_options_set_name",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_SET_SNAPSHOT = FridaLibraryLoader.findFunction("frida_script_options_set_snapshot",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_SET_SNAPSHOT_TRANSPORT = FridaLibraryLoader.findFunction("frida_script_options_set_snapshot_transport",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_SCRIPT_OPTIONS_SET_RUNTIME = FridaLibraryLoader.findFunction("frida_script_options_set_runtime",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_SCRIPT_OPTIONS_GET_NAME = FridaLibraryLoader.findFunction("frida_script_options_get_name",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_GET_SNAPSHOT = FridaLibraryLoader.findFunction("frida_script_options_get_snapshot",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_GET_SNAPSHOT_TRANSPORT = FridaLibraryLoader.findFunction("frida_script_options_get_snapshot_transport",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_SCRIPT_OPTIONS_GET_RUNTIME = FridaLibraryLoader.findFunction("frida_script_options_get_runtime",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    }
    ...
    public byte[] getSnapshot() {
        try {
            MemorySegment gBytesPtr = (MemorySegment) FRIDA_SCRIPT_OPTIONS_GET_SNAPSHOT.invoke(optionsPtr);
