...
public class SessionOptions implements AutoCloseable {
    ...
    static {
        ...
        FRIDA_SESSION_OPTIONS_NEW = FridaLibraryLoader.findFunction("frida_session_options_new",
                FunctionDescriptor.of(ValueLayout.ADDRESS));
        FRIDA_SESSION_OPTIONS_SET_REALM = FridaLibraryLoader.findFunction("frida_session_options_set_realm",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_SESSION_OPTIONS_SET_PERSIST_TIMEOUT = FridaLibraryLoader.findFunction("frida_session_options_set_persist_timeout",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_SESSION_OPTIONS_GET_REALM = FridaLibraryLoader.findFunction("frida_session_options_get_realm",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_SESSION_OPTIONS_GET_PERSIST_TIMEOUT = FridaLibraryLoader.findFunction("frida_session_options_get_persist_timeout",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    }
     ...
     * Used internally when passing options to device methods
     */
