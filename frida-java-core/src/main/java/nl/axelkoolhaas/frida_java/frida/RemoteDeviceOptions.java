...
public class RemoteDeviceOptions implements AutoCloseable {
    ...
    static {
        ...
        FRIDA_REMOTE_DEVICE_OPTIONS_NEW = FridaLibraryLoader.findFunction("frida_remote_device_options_new",
                FunctionDescriptor.of(ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_SET_CERTIFICATE = FridaLibraryLoader.findFunction("frida_remote_device_options_set_certificate",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_SET_ORIGIN = FridaLibraryLoader.findFunction("frida_remote_device_options_set_origin",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_SET_TOKEN = FridaLibraryLoader.findFunction("frida_remote_device_options_set_token",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_SET_KEEPALIVE_INTERVAL = FridaLibraryLoader.findFunction("frida_remote_device_options_set_keepalive_interval",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT));
        FRIDA_REMOTE_DEVICE_OPTIONS_GET_CERTIFICATE = FridaLibraryLoader.findFunction("frida_remote_device_options_get_certificate",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_GET_ORIGIN = FridaLibraryLoader.findFunction("frida_remote_device_options_get_origin",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_GET_TOKEN = FridaLibraryLoader.findFunction("frida_remote_device_options_get_token",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_REMOTE_DEVICE_OPTIONS_GET_KEEPALIVE_INTERVAL = FridaLibraryLoader.findFunction("frida_remote_device_options_get_keepalive_interval",
    ...
    public Certificate getCertificate() {
        try {
            MemorySegment certPtr = (MemorySegment) FRIDA_REMOTE_DEVICE_OPTIONS_GET_CERTIFICATE.invoke(optionsPtr);
    ...
    public String getOrigin() {
        try {
            MemorySegment originPtr = (MemorySegment) FRIDA_REMOTE_DEVICE_OPTIONS_GET_ORIGIN.invoke(optionsPtr);
    ...
    public String getToken() {
        try {
            MemorySegment tokenPtr = (MemorySegment) FRIDA_REMOTE_DEVICE_OPTIONS_GET_TOKEN.invoke(optionsPtr);
     ...
     * Used internally when passing options to device manager methods
     */
