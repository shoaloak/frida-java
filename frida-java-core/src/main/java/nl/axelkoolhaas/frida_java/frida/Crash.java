...
public final class Crash {
    ...
    static {
        ...
        FRIDA_CRASH_GET_PID = FridaLibraryLoader.findFunction("frida_crash_get_pid",
                FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
        FRIDA_CRASH_GET_PROCESS_NAME = FridaLibraryLoader.findFunction("frida_crash_get_process_name",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CRASH_GET_SUMMARY = FridaLibraryLoader.findFunction("frida_crash_get_summary",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CRASH_GET_REPORT = FridaLibraryLoader.findFunction("frida_crash_get_report",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
        FRIDA_CRASH_GET_PARAMETERS = FridaLibraryLoader.findFunction("frida_crash_get_parameters",
                FunctionDescriptor.of(ValueLayout.ADDRESS, ValueLayout.ADDRESS));
    }
