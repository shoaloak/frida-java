...
/**
 * Interface definitions for all Frida signals. Signatures are strictly mapped to the Vala/C
 * implementation in frida-core.
 */
public final class SignalCallbacks {
  ...
  /**
   * Called for signals with no arguments other than the instance. Used for: starting, finished,
   * file-changed, destroyed, lost, changed.
   */
  @FunctionalInterface
