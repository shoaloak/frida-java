...
public class GHashTableUtil {
  ...
  static {
    ...
    G_LIST_LENGTH =
        FridaLibraryLoader.findFunction(
            "g_list_length", FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS));
    G_LIST_NTH_DATA =
        FridaLibraryLoader.findFunction(
            "g_list_nth_data",
  ...
  /**
   * Convert a value pointer to a Java object This handles both GValue and direct value cases
   *
